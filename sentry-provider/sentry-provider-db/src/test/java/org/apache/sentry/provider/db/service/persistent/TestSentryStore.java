...
public class TestSentryStore extends org.junit.Assert {
  ...
  public void testGetTSentryRolesForUser() throws Exception {
    ...
    Set<TSentryRole> roles = sentryStore.getTSentryRolesForUser(
    ...
    roles = sentryStore.getTSentryRolesForUser(Sets.newHashSet(userToGroups.get(user2)),
    ...
    roles = sentryStore.getTSentryRolesForUser(Sets.newHashSet(userToGroups.get(user3)),
    ...
    roles = sentryStore.getTSentryRolesForUser(Sets.newHashSet(userToGroups.get(user4)),
